...
const ConnectingDots = () => {
  ...
  return (
    <div
      ...
      <button className='absolute bottom-4 right-4 w-10 h-10 flex items-center justify-center rounded-full bg-black transition-colors' onClick={() => window.location.reload()}>
        <FontAwesomeIcon icon={faSyncAlt} className='text-white  hover:text-gray-400 text-xl' />
      </button>
    </div>
  )
}
